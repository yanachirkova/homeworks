...
sample_metadata <- read.csv("input/sample_metadata.csv")
mass_spec_results <- read.csv("input/mass_spec_results.csv")
...
write.csv(left_anti_join_results, "output/left_anti_join_results.csv", row.names = FALSE)
write.csv(right_anti_join_results, "output/right_anti_join_results.csv", row.names = FALSE)
write.csv(anti_outer_join_results, "output/anti_outer_join_results.csv", row.names = FALSE)
